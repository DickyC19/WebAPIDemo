...
public class WebAPI {
    public static void getNowPlaying() {
        String APIkey = "952041b8ec1eed622ddb23980c3158d1"; // your personal API key on TheMovieDatabase
        ...
        JSONArray genreList = jsonObj2.getJSONArray("genres");
        for (int i = 0; i < genreList.length(); i ++) {
            JSONObject genreObject = genreList.getJSONObject(i);
